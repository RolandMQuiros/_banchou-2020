...
namespace FluentBehaviourTree
{
    ...
    /// </summary>
    public class ParallelNode<TContext> : IParentBehaviourTreeNode<TContext>
    {
        /// <summary>
        /// Name of the node.
        /// </summary>
        ...
        /// List of child nodes.
        /// </summary>
        private List<IBehaviourTreeNode<TContext>> children = new List<IBehaviourTreeNode<TContext>>();
